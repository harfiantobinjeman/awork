...
using AWork.Domain.Dto.Person;

#nullable disable

namespace AWork.Persistence
{
    public partial class AdventureWorks2019Context : IdentityDbContext<User>
    {
        ...
        public virtual DbSet<CountryRegionCurrencyDto> CountryRegionCurrencies { get; set; }
        ...
        public virtual DbSet<PersonEmployeeType> PersonEmployeeTypes { get; set; }
        public virtual DbSet<JobTitleType> JobTitleTypes { get; set; }
        public virtual DbSet<TotalPersonByPersonType> GetTotalPersonByPersonTypeSQL { get; set; }
        public virtual DbSet<TotalPersonByCountry> GetTotalPersonByCountrySQL { get; set; }
        public virtual DbSet<JmlhEmployeTiapDepartement> JmlhEmp { get; set; }
        public virtual DbSet<SalaryRateEmployeeDto> TotalEmp { get; set; }
        public virtual DbSet<GetShipMethod> GetShipMethods { get; set; }
        public virtual DbSet<PersonEmployeeData> PersonEmployeeDataSQL { get; set; }
        public virtual DbSet<GetDataTerritory> DataTerritorySQL { get; set; }
        public virtual DbSet<TotalProductByCategory> GetTotalProductByCategories { get; set; }
        public virtual DbSet<TotalProductBySub> GetTotalProductBySub { get; set; }
        public virtual DbSet<GetCategory> GetCategoryById { get; set; }
        public virtual DbSet<GetDataPersonCustomer> DataPersonCustomerSQL { get; set; }
        public virtual DbSet<CartPurchaseItem> CartPurchaseItems { get; set; }
        public virtual DbSet<GetSubcategory> GetSubcategoriesById { get; set; }

        public virtual DbSet<GetSalesPersonDto> GetSalesPersonSQL { get; set; }
        public virtual DbSet<GetSalesCustomerDto> GetSalesCustomerSQL { get; set; }
        public virtual DbSet<GetShipToAddresDto> GetShipToAddresSQL { get; set; }
        public virtual DbSet<GetShipMettodDto> GetShipMettodSQL { get; set; }

        public virtual DbSet<GetBillToAddressDto> GetBillToAddressSQL { get; set; }





        public virtual DbSet<LookUpCountryRegionDanStateprovince> GetCountryRegionStateProvinceSQL { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Apply RoleConfigiurations
            modelBuilder.ApplyConfiguration(new RoleConfiguration());

            modelBuilder.Entity<GetSubcategory>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetSubcategoriesById");
            });

            modelBuilder.Entity<GetCategory>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetCategoryById");
            });
            modelBuilder.Entity<TotalProductByCategory>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetTotalProductByCategories");
            });
            modelBuilder.Entity<TotalProductBySub>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetTotalProductBySub");
            });


            modelBuilder.HasAnnotation("Relational:Collation", "SQL_Latin1_General_CP1_CI_AS");
            modelBuilder.Entity<GetShipMethod>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetShipMethods");
            });

            modelBuilder.Entity<PersonEmployeeData>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("PersonEmployeeDataSQL");
            });
            
            modelBuilder.Entity<GetDataTerritory>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("DataTerritorySQL");
            });
         

            modelBuilder.Entity<CartPurchaseItem>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("CartPurchaseItems");
            });
            modelBuilder.Entity<JobTitleType>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("JobTitleTypes");
            });
            modelBuilder.Entity<TotalPersonByPersonType>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetTotalPersonByPersonTypeSQL");
            });
            modelBuilder.Entity<GetSalesPersonDto>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetSalesPersonSQL");
            });
            modelBuilder.Entity<GetSalesCustomerDto>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetSalesCustomerSQL");
            });
            modelBuilder.Entity<GetShipToAddresDto>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetShipToAddressSQL");
            });
            modelBuilder.Entity<GetShipMettodDto>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetShipMettodSQL");
            });
            modelBuilder.Entity<GetBillToAddressDto>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetBillToAddressSQL");
            });
            modelBuilder.Entity<TotalPersonByCountry>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetTotalPersonByCountrySQL");
            });

            modelBuilder.Entity<PersonEmployeeType>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("PersonEmployeeTypes");
            });

            modelBuilder.Entity<JmlhEmployeTiapDepartement>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("JmlhEmp");
            });

            modelBuilder.Entity<SalaryRateEmployeeDto>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("TotalEmp");
            });

            modelBuilder.Entity<LookUpCountryRegionDanStateprovince>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("GetCountryRegionStateProvinceSQL");
            });
            ...
            modelBuilder.Entity<CountryRegionCurrencyDto>(entity =>
            {
